...
def set_hub_collect_logic(world):
    ...
    world.set_rule(world.get_location(locn.quad_gb), can_get_court_gb)
    world.set_rule(world.get_location(locn.quad_rb), can_get_court_rb)
    world.set_rule(world.get_location(locn.quad_sip), can_get_court_sip)
